...
const VerifyEmailPage: FC<VerifyEmailPageProperties> = ({ csrfToken }) => {
	...
	return(
		<div className="flex justify-center items-center h-screen">
			...
			{
				!error && !loading && success ? <div className="w-11/12 md:w-1/2 lg:w-1/3 xl:w-1/4 bg-white dark:bg-secondary-dark-shade dark:text-secondary-light-shade drop-shadow rounded-md p-6">
